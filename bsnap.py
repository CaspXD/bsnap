...
class ClassName():
    ...
    def connectTest(self, config, payload):
        ...
        with session() as c:
            resp1 = c.get(config["HOST"] + 'https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fwelcome', verify=False)
            ...
            if m:
                ...
                print("[-]  Wrong Pass: " + config["USERNAME"] + ":" + config["PASSWORD"])
